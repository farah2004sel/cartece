...
export class ProfilComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.authService.personType.subscribe((t: 'physique' | 'morale') => {
      this.type = t;
    });
  }
  ...
  save(): void {
    ...
    this.authService.setProfileData(this.profileData as Utilisateur);

    setTimeout(() => {
      this.loading = false;
      alert('Profil enregistré avec succès !');
      this.router.navigate(['/commercant/tableau-de-bord']);
    }, 1500);
  }
}
