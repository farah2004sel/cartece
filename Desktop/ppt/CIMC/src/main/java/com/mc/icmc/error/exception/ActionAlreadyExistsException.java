...
@Getter
@ToString
public class ActionAlreadyExistsException extends RuntimeException implements ExceptionWithErrorResponse {

    private static final String DEFAULT_MESSAGE = "Action already exists";
    private static final String DEFAULT_CODE = "Action_already_exists";
